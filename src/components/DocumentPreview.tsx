              ...
              <table style={{
                ...
                <thead>
                  <tr style={{ borderBottom: '1.5px solid #000000', background: '#ffffff' }}>
                    ...
                    <th style={{ borderRight: '1px solid #000000', padding: '0.5rem', textAlign: 'center', width: '100px', fontWeight: 700, color: '#000000' }}>Qty</th>
                    <th style={{ borderRight: '1px solid #000000', padding: '0.5rem', textAlign: 'center', width: '70px', fontWeight: 700, color: '#000000' }}>Days</th>
                    <th style={{ borderRight: '1px solid #000000', padding: '0.5rem', textAlign: 'right', width: '90px', fontWeight: 700, color: '#000000' }}>Rate</th>
                    <th style={{ padding: '0.5rem', textAlign: 'right', width: '100px', fontWeight: 700, color: '#000000' }}>Amount</th>
                  </tr>
                </thead>
                <tbody>
                  {items.map((item, idx) => (
                    <tr key={item.id} style={{ borderBottom: '1px solid #000000' }}>
                      ...
                      <td className="mono" style={{ borderRight: '1px solid #000000', padding: '0.65rem 0.5rem', textAlign: 'right' }}>
                        {item.rate > 0 ? Number(item.rate).toFixed(2) : ''}
                      </td>
